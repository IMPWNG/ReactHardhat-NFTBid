    ...
    var controls = {
        ...
        mount: function () {
            ...
            pendingAnimations.forEach(function (_a) {
                ...
                controls.start.apply(controls, tslib.__spread(animation)).then(resolve);
            });
            return function () {
                hasMounted = false;
                controls.stop();
...
function createVisualState(props, parent, blockInitialAnimation) {
    ...
    if (initialToSet &&
        ...
        list.forEach(function (definition) {
            ...
            if (!resolved)
                return;
            var transitionEnd = resolved.transitionEnd, transition = resolved.transition, target = tslib.__rest(resolved, ["transitionEnd", "transition"]);
            for (var key in target)
...
var visualElement = function (_a) {
    ...
    return function (_a, options) {
        ...
        var element = tslib.__assign(tslib.__assign({ treeType: treeType, 
             ...
             */
            path: parent ? tslib.__spread(parent.path, [parent]) : [], 
            /**
             *
             */
            ...
            scheduleUpdateLayoutProjection: parent
                ...
                : function () { return sync__default['default'].preRender(element.updateLayoutProjection, false, true); }, 
            /**
            ...
            updateLayoutMeasurement: function () {
                ...
                sync__default['default'].update(function () { return element.rebaseProjectionTarget(); });
            },
            /**
...
var svgMutableState = function () { return (tslib.__assign(tslib.__assign({}, htmlConfig.createRenderState()), { attrs: {}, dimensions: zeroDimensions })); };
var svgVisualElement = visualElement(tslib.__assign(tslib.__assign({}, htmlConfig), { createRenderState: svgMutableState, onMount: function (element, instance, mutableState) {
        try {
...
function useStyle(visualElement, props) {
    ...
    style = tslib.__assign(tslib.__assign({}, style), useInitialMotionValues(visualElement));
...
function MotionConfig(_a) {
    var children = _a.children, _b = _a.features, features = _b === void 0 ? [] : _b, transition = _a.transition, props = tslib.__rest(_a, ["children", "features", "transition"]);
    var pluginContext = React.useContext(MotionConfigContext);
    var loadedFeatures = tslib.__spread(new Set(tslib.__spread(pluginContext.features, features)));
...
function useInitialMotionProps(visualElement, props) {
    var createAttrs = function () {
        ...
        return tslib.__assign(tslib.__assign({}, attrs), resolvedMotionValueProps);
    };
...
function createUseRender(Component, forwardMotionProps) {
    ...
    var useRender = function (props, visualElement) {
        ...
        return React.createElement(Component, tslib.__assign(tslib.__assign(tslib.__assign({}, filterProps(props, typeof Component === "string", forwardMotionProps)), { ref: visualElement.ref }), visualProps));
    };
    return useRender;
}
...
function useVisualElement(createVisualElement, props, isStatic, ref) {
    ...
    var visualElementRef = React.useRef(null);
...
function createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(MotionContext.Provider, { value: visualElement }, component),
            features));
    }
...
var Animate = /** @class */ (function (_super) {
    ...
    function Animate() {
        ...
        _this.animate = function (target, origin, _a) {
            if (_a === void 0) { _a = {}; }
            var originBox = _a.originBox, targetBox = _a.targetBox, visibilityAction = _a.visibilityAction, shouldStackAnimate = _a.shouldStackAnimate, onComplete = _a.onComplete, config = tslib.__rest(_a, ["originBox", "targetBox", "visibilityAction", "shouldStackAnimate", "onComplete"]);
...
function createMotionProxy(defaultFeatures) {
    ...
    function deprecatedCustom(Component) {
        heyListen.warning(false, "motion.custom() is deprecated. Use motion() instead.");
...
function createCrossfader() {
    ...
    function startCrossfadeAnimation(target, transition) {
        ...
        return animate(progress, target, tslib.__assign(tslib.__assign({}, transition), { onUpdate: function () {
    ...
    function updateCrossfade() {
        ...
        if (options.crossfadeOpacity && follow) {
            leadState.opacity = popmotion.mix(0, leadTargetOpacity, easeCrossfadeIn(p));
