 ...
 * @public
 */
export declare function animate<V>(from: MotionValue<V> | V, to: V | V[], transition?: AnimationOptions_2<V>): PlaybackControls_2;
 ...
 * @internal
 */
export declare function createMotionComponent<P extends {}, E>({ defaultFeatures, createVisualElement, useRender, }: MotionComponentConfig<E>): React.ForwardRefExoticComponent<React.PropsWithoutRef<P & MotionProps> & React.RefAttributes<E>>;

declare type CreateVisualElement<E> = (isStatic: boolean, options: VisualElementOptions<E>) => VisualElement<E>;
...
declare interface DomMotionComponentConfig {
 ...
 * @public
 */
export declare const m: (<Props>(Component: string | import("react").ComponentClass<Props, any> | import("react").FunctionComponent<Props>, { forwardMotionProps }?: import("./motion").DomMotionComponentConfig) => import("./motion").CustomDomComponent<Props>) & import("./types").HTMLMotionComponents & import("./types").SVGMotionComponents & {
 ...
 * @public
 */
export declare const motion: (<Props>(Component: string | React.ComponentClass<Props, any> | React.FunctionComponent<Props>, { forwardMotionProps }?: DomMotionComponentConfig) => CustomDomComponent<Props>) & HTMLMotionComponents & SVGMotionComponents & {
 ...
 * @public
 */
export declare function MotionConfig({ children, features, transition, ...props }: MotionConfigProps): JSX.Element;
 ...
 * @public
 */
export declare interface MotionProps extends AnimationProps, VisualElementLifecycles, GestureHandlers, DraggableProps, LayoutProps, MotionAdvancedProps {
    /**
...
declare interface PlaybackControls_2 {
    stop: () => void;
}
...
declare type RenderComponent = (props: MotionProps, visualElement: VisualElement) => any;
...
declare interface VisualElementConfig<Instance, MutableState, Options> {
    ...
    build(visualElement: VisualElement<Instance>, renderState: MutableState, latestValues: ResolvedValues, projection: TargetProjection, layoutState: LayoutState, options: Options, props: MotionProps): void;
